...
public class ConcertPromotor 
{
 ...
 public static void main(String[] args) {
  ...
  while(input.equalsIgnoreCase("quit")!= true)
  {
   ...
   System.out.println("Has sold "+concert.getphoneticket()+" tickets by phone");
   System.out.println("Has sold "+concert.getvenueticket()+" tickets at the venue");
   ...
   case 9:
    ...
    double phoneprice = keyboard.nextDouble();
    System.out.println("Enter the price at the venue");
    double venueprice = keyboard.nextDouble();
    concert = new Concert(name,capacity,phoneprice,venueprice);    
    break;
   case 0:
    input = "quit";
    break;
